...
class ReparationMecaniqueController extends AbstractController
{
    #[Route('/reparation/mecanique', name: 'Réparation', methods: ['GET','POST'])]
    ...
    ): Response
    {
        ...
        return $this->render('reparation_mecanique/index.html.twig', [
